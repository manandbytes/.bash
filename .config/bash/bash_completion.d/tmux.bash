...
# TODO is not part of current bash-completion 1:2.16.0-8
...
_comp_cmd_tmux__subcommand()
{
    ...
    local usage
    usage=$(_comp_cmd_tmux__run list-commands \
...
_comp_cmd_tmux()
{
    #  warning  SC2034 prev appears unused. Verify use (or export if used externally). (sh-shellcheck)
    local cur words cword comp_args
